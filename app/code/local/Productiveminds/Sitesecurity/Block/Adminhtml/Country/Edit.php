...
class Productiveminds_Sitesecurity_Block_Adminhtml_Country_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('sitesecurity_data') && Mage::registry('sitesecurity_data')->getId())
        {
            ...
            return Mage::helper('sitesecurity')->__('Edit Country: %s', $countryName);
        } else {
            return Mage::helper('sitesecurity')->__('New Country');
        }
    }
