...
class Productiveminds_Sitesecurity_Block_Adminhtml_Sitesecure_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('sitesecurity/adminhtml_sitesecure_edit_tab_form')->toHtml(),
        ));
        ...
        $this->addTab('sitesecurity_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('sitesecurity/adminhtml_sitesecure_edit_tab_Options')->toHtml(),
        ));
