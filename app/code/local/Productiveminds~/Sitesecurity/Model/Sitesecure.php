...
class Productiveminds_Sitesecurity_Model_Sitesecure extends Mage_Core_Model_Abstract
{
	...
	public function denyAction($denyParams = null) {
		...
		if($denyParams != null) {
			...
			$ipAddress = $denyParams[Productiveminds_Sitesecurity_Model_Security::ACCESS_DENIED_VISITED_IP];
			$ipAddress2long = Mage::getModel('sitesecurity/security')->getIp2long($ipAddress);
			...
			$this->setRemoteAddr($ipAddress2long);
