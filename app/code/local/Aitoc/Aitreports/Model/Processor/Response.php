<?php
class Aitoc_Aitreports_Model_Processor_Response
{
    ...
    protected $_allowedMessageTypes = array(
        Aitoc_Aitreports_Model_Processor::RESULT_NOTICE,
        Aitoc_Aitreports_Model_Processor::RESULT_ERROR,
        Aitoc_Aitreports_Model_Processor::RESULT_SUCCESS
    );
     ...
     * 
     * @return Aitoc_Aitreports_Model_Processor_Response
     */
