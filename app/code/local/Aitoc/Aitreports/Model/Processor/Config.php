<?php
class Aitoc_Aitreports_Model_Processor_Config extends Mage_Core_Model_Config_Data
{
    protected $_config_path = 'sales/aitreports/iterator';
    
    // default config
    protected $_config = array(
        'iterator'   => Aitoc_Aitreports_Model_Processor::ITERATOR_CRON,
        'status'     => Aitoc_Aitreports_Model_Processor::ITERATOR_STATUS_FREE,
        'time'       => 0,
        'process'    => '',
        'options'    => array() 
    );
    ...
    {
        $this->_init('aitreports/processor_config');
