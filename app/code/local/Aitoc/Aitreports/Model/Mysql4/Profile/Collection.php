...
class Aitoc_Aitreports_Model_Mysql4_Profile_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    public function _construct()
    {
        $this->_init('aitreports/profile');
    }
    ...
    * @return Aitoc_Aitreports_Model_Mysql4_Profile_Collection
    */
