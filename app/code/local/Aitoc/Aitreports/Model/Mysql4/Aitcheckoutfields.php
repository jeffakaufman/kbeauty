...
class Aitoc_Aitreports_Model_Mysql4_Aitcheckoutfields extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    {
        $db = Mage::getSingleton('core/resource')->getConnection('core_write');
        $helper = Mage::helper('aitreports/aitcheckoutfields');
        /* @var $helper Aitoc_Aitreports_Helper_Aitcheckoutfields */
