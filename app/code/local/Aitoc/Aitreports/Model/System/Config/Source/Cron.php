<?php 
class Aitoc_Aitreports_Model_System_Config_Source_Cron
{
    ...
    const FREQ_MOND  = '0 1 * * 1';//'each monday';
    const FREQ_SUND  = '0 1 * * 0';//'each sunday';
    const FREQ_MONTH = '0 1 1 * *';//'each month'
    ...
    public function toOptionArray()
    {
        ...
        $options = array(
            ...
            array('value' => self::FREQ_MOND, 'label' => $helper->__('Each Monday')),
            array('value' => self::FREQ_SUND, 'label' => $helper->__('Each Sunday')),
            array('value' => self::FREQ_MONTH, 'label' => $helper->__('Each Month')),
            );
    ...
    public function toStrToTimeArray()
    {
        $options = array(
            ...
            self::FREQ_1D       => '1 day',
            self::FREQ_1D       => 'Each Monday',
            self::FREQ_1D       => 'Each Sunday',
            self::FREQ_1D       => 'Each Month',
        );
