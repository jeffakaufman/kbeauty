<?php
class Aitoc_Aitreports_Model_Processor
{
    ...
    const ITERATOR_CONFIG_PATH = 'sales/aitreports/iterator';
     ...
     */
    protected $_config;
    protected $_configModel = 'aitreports/processor_config';
    ...
    /**
     * @return Aitoc_Aitreports_Model_Processor_Config
     */
     ...
     * 
     * @return Aitoc_Aitreports_Model_Processor
     */
     ...
     * 
     * @return @return Aitoc_Aitreports_Model_Processor
     */
    ...
    public function run()
    {
        if((bool)$this->launch() && (bool)$this->getProcess())
        {
            try
            {
                ...
                $model = Mage::getModel('aitreports/'.$processModel);
                $model->{$processMethod}($this->_config()->get('options'));
            }
            catch(Exception $e)
            {
                Mage::getSingleton('aitreports/processor_response')->addMessage('error', $e->getMessage());
                Mage::log((string)$e, false, 'aitreports_exception.log');
            }
