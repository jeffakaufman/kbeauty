...
class Aitoc_Aitreports_Model_Export_Type_Shipment extends Aitoc_Aitreports_Model_Export_Type_Complex implements Aitoc_Aitreports_Model_Export_Type_Interface
{
    /**
     * 
    ...
    public function prepareXml(SimpleXMLElement $orderXml, Mage_Core_Model_Abstract $order, Varien_Object $exportConfig)
    {
        ...
        foreach ($order->getShipmentsCollection() as $shipment)
        {
            ...
            {
                if($field == 'shipping_label') //fix for fedEx
                {
                    continue;
                }
