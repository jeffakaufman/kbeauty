...
class Aitoc_Aitreports_Model_Export_Type_Order extends Aitoc_Aitreports_Model_Export_Type_Complex implements Aitoc_Aitreports_Model_Export_Type_Interface
{
    ...
    public function prepareXml(SimpleXMLElement $orderXml, Mage_Core_Model_Abstract $order, Varien_Object $exportConfig)
    {
        ...
        $orderFieldsXml->addChild('first_order', $order->getFirstOrder());
    ...
    {
        if(Mage::helper('aitreports')->isPreorderEnabled())
        {
    ...
    public function getOrderFields()
    {
        if(version_compare(Mage::getVersion(), '1.4.1.0', '<')) {
            ...
            $fields = array_unique(array_merge($fields, Mage::helper('aitreports')->getEntityFields('order')));
        } else {
