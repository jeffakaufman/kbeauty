...
class Aitoc_Aitreports_Block_Export_Log_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        /* @var $currentExport Aitoc_Aitreports_Model_Export */
        ...
        {
                $exportCollection = Mage::getResourceModel('aitreports/export_order_collection');
