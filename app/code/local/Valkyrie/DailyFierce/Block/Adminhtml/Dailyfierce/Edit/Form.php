...
class Valkyrie_DailyFierce_Block_Adminhtml_DailyFierce_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
...
//var_dump(Mage::getSingleton('adminhtml/session'));
    ...
    elseif (Mage::registry('dailyfierce'))
    {
      $data = Mage::registry('dailyfierce')->getData();
    }
    else
    {
      $data = array();
    ...
    $fieldset = $form->addFieldset('dailyfierce_form', array(
      'legend' =>Mage::helper('dailyfierce')->__('Daily Fierce Information')
    ));

    $fieldset->addField('title', 'text', array(
      'label'     => Mage::helper('dailyfierce')->__('Title'),
...
*/
    ...
    $fieldset->addField('details_content', 'textarea', array(
        'label'     => Mage::helper('dailyfierce')->__('Details'),
...
*/
      ...
      $fieldset->addField('active_from', 'date', array(
          'label'     => Mage::helper('dailyfierce')->__('Date Start'),
          'name'      => 'active_from',
          'class'     => 'validate-date',
      ...
      $fieldset->addField('active_to', 'date', array(
          'label'     => Mage::helper('dailyfierce')->__('Date End'),
          'name'      => 'active_to',
          'class'     => 'validate-date',
          'after_element_html' => '<small>Select Date</small>',
          'image'     => $this->getSkinUrl('images/grid-cal.gif'),
