...
class Valkyrie_DailyFierce_Block_Adminhtml_DailyFierce_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
    parent::__construct();
    $this->setId('dailyfierce_grid');
  ...
  protected function _getCollectionClass()
  {
    ...
    return 'dailyfierce/dailyfierce_collection';
  }
...
//echo "<pre>";var_dump($collection);die();
  ...
  {
    $this->addColumn('fierce_id', array(
      'header'    => Mage::helper('dailyfierce')->__('ID'),
      'align'     => 'right',
      'width'     => '50px',
      'index'     => 'promotion_id',
    ));
    ...
    $this->addColumn('title', array(
      'header'    => Mage::helper('dailyfierce')->__('Title'),
      'align'     => 'left',
      'index'     => 'title',
    ));
...
*/
     ...
     $this->addColumn('active_from', array(
      'header'    => Mage::helper('dailyfierce')->__('Date Start'),
      'align'     => 'center',
      'index'     => 'active_from',
      'width'     => '30px',
         'type' => 'date',
     ...
     $this->addColumn('active_to', array(
      'header'    => Mage::helper('dailyfierce')->__('Date End'),
      'align'     => 'center',
      'index'     => 'active_to',
      'width'     => '30px',
         'type' => 'date',
